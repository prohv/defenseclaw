---
title: Overview
description: DefenseClaw is the Cisco governance layer for AI coding agents — scan capabilities before they run, inspect runtime traffic, and export durable audit evidence across twelve first-class connectors.
keywords:
...
>
  ...
  <Node id="audit" kind="datastore">SQLite + JSONL</Node>
